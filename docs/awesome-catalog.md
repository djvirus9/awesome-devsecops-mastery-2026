...
- [Shift Left and Developer Security](#shift-left-and-developer-security)
- [SAST](#sast)
- [SCA and Dependency Management](#sca-and-dependency-management)
- [Secrets Management](#secrets-management)
- [IaC and Cloud Security](#iac-and-cloud-security)
...
- [Runtime Detection and Response](#runtime-detection-and-response)
- [Observability and Telemetry](#observability-and-telemetry)
- [Incident Response and SOAR](#incident-response-and-soar)
- [Threat Modeling](#threat-modeling)
- [Compliance and Frameworks](#compliance-and-frameworks)
- [SBOM and Vulnerability Databases](#sbom-and-vulnerability-databases)
...
## Shift Left and Developer Security

- [pre-commit](https://pre-commit.com/)
- [Gitleaks](https://github.com/gitleaks/gitleaks)
- [Talisman](https://github.com/thoughtworks/talisman)
- [Snyk IDE](https://snyk.io/)
